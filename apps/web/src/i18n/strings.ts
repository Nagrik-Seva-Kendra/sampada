...
export const strings = {
  ...
  authSignupFailed: {
    en: "Signup failed — that email may already be registered.",
    hi: "साइन अप विफल — यह ईमेल पहले से पंजीकृत हो सकता है।",
  },
  ...
  authPending: {
    en: "Your signup is awaiting admin approval.",
    hi: "आपका साइन अप एडमिन की मंजूरी की प्रतीक्षा में है।",
  },
  ...
  partnerSignupFailed: {
    en: "Registration failed — that email may already be registered.",
    hi: "पंजीकरण विफल — यह ईमेल पहले से पंजीकृत हो सकता है।",
  },
