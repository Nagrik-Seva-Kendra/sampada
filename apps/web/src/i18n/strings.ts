...
export const strings = {
  ...
  allDeedsFilterStatus: { en: "Status", hi: "स्थिति" },
  allDeedsFilterAllStatuses: { en: "All statuses", hi: "सभी स्थितियां" },
  allDeedsFilterCreator: { en: "Creator", hi: "निर्माता" },
  allDeedsFilterAllCreators: { en: "All creators", hi: "सभी निर्माता" },
  allDeedsFilterDateFrom: { en: "From", hi: "से" },
  allDeedsFilterDateTo: { en: "To", hi: "तक" },
