...
import { useDeleteGuideline, useGuidelineList, useUploadGuideline, guidelineFileUrl } from "./useGuideline";
  ...
  return (
    <section className="page">
      <div className="wrap">
        ...
        <p className="er-sub">
          {T(
            "Upload PDF documents here — they'll be visible and downloadable by everyone on the Guideline page.",
            "यहां PDF दस्तावेज़ अपलोड करें — ये गाइडलाइन पेज पर सभी को दिखेंगे और डाउनलोड के लिए उपलब्ध होंगे।",
          )}
        </p>
