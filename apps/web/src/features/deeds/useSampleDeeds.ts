...
/**
 * Alias of useSaveSampleDeed. DeedEditPage imports this name (the editor's
 * explicit Save button + auto-save both go through it) — kept as a separate
 * export so both names resolve to the same mutation hook.
 */
export const useUpdateSampleDeed = useSaveSampleDeed;
